...
export const ESP32C6_RTC_CNTL_WDTCONFIG0_REG = ESP32C6_DR_REG_LP_WDT_BASE + 0x0; // LP_WDT_RWDT_CONFIG0_REG
...
export const ESP32H2_RTC_CNTL_WDTCONFIG0_REG = ESP32H2_DR_REG_LP_WDT_BASE + 0x0; // LP_WDT_RWDT_CONFIG0_REG
...
export const ESP32H4_RTC_CNTL_WDTCONFIG0_REG = ESP32H4_DR_REG_LP_WDT_BASE + 0x0; // LP_WDT_RWDT_CONFIG0_REG
export const ESP32H4_RTC_CNTL_WDTCONFIG1_REG = ESP32H4_DR_REG_LP_WDT_BASE + 0x4; // not verified!!!
...
export const ESP32H21_RTC_CNTL_WDTCONFIG0_REG =
  ESP32H21_DR_REG_LP_WDT_BASE + 0x0;
export const ESP32H21_RTC_CNTL_WDTCONFIG1_REG =
  ESP32H21_DR_REG_LP_WDT_BASE + 0x4; // not verified!!!
...
export const ESP32P4_RTC_CNTL_WDTCONFIG0_REG = ESP32P4_DR_REG_LP_WDT_BASE + 0x0; // LP_WDT_CONFIG0_REG
